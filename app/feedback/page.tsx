...
export const metadata: Metadata = {
  title: 'Feedback',
  description: 'Report a bug or suggest an idea for Limitless Arcade.',
};

export default function FeedbackPage() {
  return (
    // `py-16` rather than a scrolling box inside the page: on a short screen
    // the whole page scrolls, which keeps the heading and the submit button
    // reachable instead of hiding them inside a container of their own.
    <main className="relative flex flex-1 flex-col items-center justify-center bg-slate-100 px-4 py-16 dark:bg-[#0a0a1a]">
      <div className="pointer-events-none fixed inset-0 bg-[radial-gradient(ellipse_at_top,#e2e8f0_0%,#f1f5f9_70%)] dark:bg-[radial-gradient(ellipse_at_top,#15152b_0%,#0a0a1a_70%)]" />
      ...
      <div className="relative z-10 flex w-full max-w-sm flex-col items-center gap-8">
        ...
        {/* The form reads ?from= with useSearchParams, which needs a Suspense
