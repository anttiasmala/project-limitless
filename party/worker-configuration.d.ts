/* eslint-disable */
// Generated by Wrangler by running `wrangler types party/worker-configuration.d.ts` (hash: 4ccd665393cf9a4f7913a44a7698e228)
// Runtime types generated with workerd@1.20260722.1 2026-03-30 
interface __BaseEnv_Env {
	NEXT_PUBLIC_PARTYKIT_HOST_: string;
	NEXT_PUBLIC_PARTYKIT_HOST: string;
	ALLOWED_DEV_ORIGINS: string;
	Game: DurableObjectNamespace<import("./index").GameRoom>;
	Lobby: DurableObjectNamespace<import("./index").LobbyServer>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "GameRoom" | "LobbyServer";
	}
