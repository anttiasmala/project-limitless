...
import Lobby from '@/components/tictactoe/multiplayer/Lobby';
import Button from '@/components/shared/Button';
import { useState } from 'react';
import { Modal } from '@/components/shared/Modal';
import { useLocalStorage } from '@/hooks/useLocalStorage';
import { ICON_LIST as PIRATE_ICONS } from '@/components/tictactoe/settings/IconPickerModal';
...
function ProfileModal({
  ...
  return (
    <Modal open onClose={onClose} ariaLabel="Pirate profile">
      <div className="relative flex w-[90vw] max-w-sm flex-col gap-5 rounded-xl border-2 border-amber-800 bg-amber-50 p-6 shadow-2xl dark:border-amber-700 dark:bg-amber-950">
